...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/setting/setTunnel", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setTunnel)
	ginServer.Handle("POST", "/api/setting/getTunnel", model.CheckAuth, model.CheckAdminRole, getTunnel)
	ginServer.Handle("POST", "/api/tunnel/status", model.CheckAuth, model.CheckAdminRole, tunnelStatus)
